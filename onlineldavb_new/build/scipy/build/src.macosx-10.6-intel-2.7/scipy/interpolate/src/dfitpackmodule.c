...
/*frompyobj*/
  ...
  /* Processing variable w */
  w_Dims[0]=m;
  capi_w_intent |= F2PY_OPTIONAL|F2PY_INTENT_IN|F2PY_INTENT_OUT;
  capi_w_tmp = array_from_pyobj(PyArray_DOUBLE,w_Dims,w_Rank,capi_w_intent,w_capi);
  if (capi_w_tmp == NULL) {
    if (!PyErr_Occurred())
  ...
  nrdata_Dims[0]=nest;
  capi_nrdata_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_CACHE|F2PY_INTENT_OUT;
  ...
  fpint_Dims[0]=nest;
  capi_fpint_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_CACHE|F2PY_INTENT_OUT;
...
/*frompyobj*/
  ...
  /* Processing variable w */
  w_Dims[0]=m;
  capi_w_intent |= F2PY_OPTIONAL|F2PY_INTENT_IN;
  capi_w_tmp = array_from_pyobj(PyArray_DOUBLE,w_Dims,w_Rank,capi_w_intent,w_capi);
  if (capi_w_tmp == NULL) {
    if (!PyErr_Occurred())
  ...
  wrk1_Dims[0]=lwrk1;
  capi_wrk1_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_CACHE|F2PY_INTENT_OUT;
