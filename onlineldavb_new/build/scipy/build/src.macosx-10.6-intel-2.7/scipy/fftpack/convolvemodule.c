...
if(F2PyCapsule_Check(kernel_func_capi)) {
  ...
  capi_omega_tmp = array_from_pyobj(PyArray_DOUBLE,omega_Dims,omega_Rank,capi_omega_intent,Py_None);
  if (capi_omega_tmp == NULL) {
    ...
    omega = (double *)(capi_omega_tmp->data);
...
/*frompyobj*/
  ...
  capi_omega_tmp = array_from_pyobj(PyArray_DOUBLE,omega_Dims,omega_Rank,capi_omega_intent,omega_capi);
  if (capi_omega_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  capi_omega_imag_tmp = array_from_pyobj(PyArray_DOUBLE,omega_imag_Dims,omega_imag_Rank,capi_omega_imag_intent,omega_imag_capi);
  if (capi_omega_imag_tmp == NULL) {
    ...
    omega_imag = (double *)(capi_omega_imag_tmp->data);

  /* Processing variable omega_real */
  omega_real_Dims[0]=n;
  capi_omega_real_intent |= F2PY_INTENT_C|F2PY_INTENT_CACHE|F2PY_INTENT_IN;
  capi_omega_real_tmp = array_from_pyobj(PyArray_DOUBLE,omega_real_Dims,omega_real_Rank,capi_omega_real_intent,omega_real_capi);
  if (capi_omega_real_tmp == NULL) {
    ...
    omega_real = (double *)(capi_omega_real_tmp->data);
